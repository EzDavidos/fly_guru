  ...
  return (
    <div>
      ...
      <div className="mt-4 grid grid-cols-2 gap-3">
        ...
        <Link href="/admin/agents" className={tileClass}>
          Агенты
          <span className="text-xs font-normal text-muted">реф-ссылки · награды</span>
        </Link>

        <Link href="/admin/members" className={tileClass}>
          Члены клуба
