  ...
  const steps = [
    {
      icon: IconTandem,
      title: "1. Тандем",
      text: "Пробный полёт с инструктором за 10 минут. Без обязательств — просто попробовать, как это.",
    },
    {
      icon: IconFoil,
    ...
    },
    {
      ...
      text: "Катайся сам по абонементу, езди на экскурсии и сафари с клубом.",
    },
  ];
